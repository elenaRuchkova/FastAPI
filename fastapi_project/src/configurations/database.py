...
def global_init() -> None:
    ...
    if not __async_engine:
        __async_engine = create_async_engine(url=SQLALCHEMY_DATABASE_URL,
                                              echo=False # выводит логи
                                            #   pool_size=5 # количество одновременных запросов к БД
                                            #   max_overflow=10 # количество доп запросов
                                              )  
