...
from schemas.sellers import IncomingSeller, ReturnedAllSellers, ReturnedSeller, UpdateSeller #, ,
...
async def get_all_sellers(session: DBSession):
    ...
    return {"sellers": sellers}  # для валидации создаем класс ReturnedAll
...
@sellers_router.get("/{seller_id}", response_model=ReturnedSeller)  #, response_model=ReturnedSeller
...
async def delete_seller(seller_id:int, session: DBSession):
    ...
    if deleted_seller:
        ...
        return {"message": "Seller and associated books have been deleted successfully"}
